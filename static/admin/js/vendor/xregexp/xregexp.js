 ...
 * @param {Object} context Context object to use for token handler lead_adapters.
 ...
 * lead_adapters can use named backreferences via `arguments[0].name`. Also fixes browser bugs compared
 ...
 *   Replacement lead_adapters are invoked with three or more arguments:
 ...
 * provides named backreferences to replacement lead_adapters as `arguments[0].name`. Also fixes browser
...
fixed.replace = function(search, replacement) {
    ...
    if (isType(replacement, 'Function')) {
        ...
        // lead_adapters isn't type-converted to a string
        result = nativ.replace.call(String(this), search, function() {
            ...
            // ES6 specs the context for replacement lead_adapters as `undefined`
